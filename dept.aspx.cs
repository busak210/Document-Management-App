...
public partial class dept : System.Web.UI.Page
{
    ...
    protected void btnok_Click(object sender, EventArgs e)
    {
        ...
        c = new Connect();
        c.shola();
        c.com.CommandText = "Insert into [DepartmentsInfo]([DepartmentName],[DepartmentType],[Category],[DeptHeadTitle],[DeptHeadName] )  Values('" + txtdname.Text.ToString() + "','" + dpldtype.Text + "','" + dpldcat.Text + "','" + txtdht.Text.ToString() + "','" + txtdhn.Text + "')";
