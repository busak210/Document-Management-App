<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="letterMemo.aspx.cs" Inherits="letterMemo" %>
        ...
        <tr>
            ...
            <td style="vertical-align: top;">
                <table style="width: 937px; background-color: #009933; ">
                    <tr>
                        <td colspan="6" style="border: thin solid #FFFFFF; background-color: #FFFFFF; height: 26px;">NEW LETTER/MEMO ADDITION/CREATION PLATFORM</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="height: 46px">
                            <asp:DropDownList runat="server" CssClass="form-control" Width="237px" ID="DropDownList30" AutoPostBack="True" DataSourceID="SqlDataSource3" DataTextField="FileNo" DataValueField="FileNo"></asp:DropDownList>

                                            <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:FileArchiveDBConnectionString %>" SelectCommand="SELECT [FileNo] FROM [tblFilesInfo] WHERE (([FileSubjectMatter] = @FileSubjectMatter) AND ([FileTitle] = @FileTitle))">
                                                <SelectParameters>
                                                    <asp:ControlParameter ControlID="dplfsm" Name="FileSubjectMatter" PropertyName="SelectedValue" Type="String" />
                                                    <asp:ControlParameter ControlID="dplftitle" Name="FileTitle" PropertyName="SelectedValue" Type="String" />
                                                </SelectParameters>
                            </asp:SqlDataSource>
                        </td>
                    ...
                    <tr>
                        ...
                        <td style="height: 47px">
                            <asp:DropDownList runat="server" CssClass="form-control" Width="237px" ID="dplfsm" AutoPostBack="True" DataSourceID="SqlDataSource1" DataTextField="FileSubjectMatter" DataValueField="FileSubjectMatter">
                                            ...
                                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:FileArchiveDBConnectionString %>" SelectCommand="SELECT DISTINCT [FileSubjectMatter] FROM [tblFilesInfo] ORDER BY [FileSubjectMatter]"></asp:SqlDataSource>
                        </td>
                    ...
                    <tr>
                        ...
                        <td style="width: 181px; height: 47px; color: #FFFFFF;">
                            File Title :</td>
                        <td style="height: 47px">
                            <asp:DropDownList runat="server" CssClass="form-control" Width="237px" ID="dplftitle" AutoPostBack="True" DataSourceID="SqlDataSource2" DataTextField="FileTitle" DataValueField="FileTitle">
                            </asp:DropDownList>

                                            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:FileArchiveDBConnectionString %>" SelectCommand="SELECT DISTINCT [FileTitle] FROM [tblFilesInfo] WHERE ([FileSubjectMatter] = @FileSubjectMatter)">
                                                <SelectParameters>
                                                    <asp:ControlParameter ControlID="dplfsm" Name="FileSubjectMatter" PropertyName="SelectedValue" Type="String" />
                                                </SelectParameters>
                            </asp:SqlDataSource>
                    ...
                    <tr>
                        ...
                        <td style="width: 181px; height: 47px; color: #FFFFFF;">
                            Message From :</td>
                        <td style="height: 47px">
                            <asp:TextBox ID="txtmsgfrm" runat="server" CssClass="form-control" Width="194px"></asp:TextBox>
                        </td>
                        <td style="height: 47px">&nbsp;</td>
                        <td style="height: 47px">&nbsp;</td>
                        <td style="height: 47px">&nbsp;</td>
                    ...
                    <tr>
                        ...
                        <td style="width: 181px; height: 47px; color: #FFFFFF;">
                            Message Title :</td>
                        <td style="height: 47px">
                            <asp:TextBox ID="txtmsgt" runat="server" CssClass="form-control" Width="270px" Height="33px" TextMode="MultiLine"></asp:TextBox>
                        </td>
                        <td style="height: 47px">&nbsp;</td>
                        <td style="height: 47px">&nbsp;</td>
                        <td style="height: 47px">&nbsp;</td>
                    ...
                    <tr>
                        ...
                        <td style="width: 181px; height: 47px; color: #FFFFFF;">
                            &nbsp;Received Date :</td>
                        <td style="height: 47px">
                            <asp:TextBox ID="txtrd" runat="server" CssClass="form-control" Width="194px"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td style="width: 181px; height: 47px; color: #FFFFFF;">
                            &nbsp;Comments :</td>
                        <td style="height: 47px">
                            <asp:TextBox ID="txtc" runat="server" CssClass="form-control" Width="270px" Height="33px" TextMode="MultiLine"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td style="width: 181px; height: 46px; color: #FFFFFF;">
                            Record Category :</td>
                        <td style="height: 46px"><asp:DropDownList runat="server" CssClass="form-control" Width="237px" ID="dplrc">
                     ...
                     <tr>
                        ...
                        <td style="height: 43px">
                            <asp:DropDownList runat="server" CssClass="form-control" Width="237px" ID="dplrs">
