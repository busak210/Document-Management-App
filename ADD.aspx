        ...
        <tr>
            ...
            <td style="vertical-align: top;">
                <table style="width: 937px; background-color: #009933; ">
                    <tr>
                        <td colspan="6" style="border: thin solid #FFFFFF; background-color: #FFFFFF; height: 26px;">NEW ADDITION/CREATION PLATFORM</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="width: 225px; height: 42px;">
                            <asp:Button ID="btnStaff" runat="server" CssClass="btn-lg" Font-Bold="True" Font-Size="Small" Height="38px"  Text="Add/Create New Staff" Width="286px" OnClick="btnStaff_Click"  />
                            </td>
                    ...
                    <tr>
                        ...
                        <td style="width: 225px; height: 37px;">
                            <asp:Button ID="btnnewfile" runat="server" CssClass="btn-lg" Font-Bold="True" Font-Size="Small" Height="38px"  Text="Add/Create New File" Width="286px" OnClick="btnnewfile_Click"  />
                            </td>
                    ...
                    <tr>
                        <td style="width: 124px; text-align: right; height: 32px;">
                            &nbsp;</td>
                        <td style="width: 225px; height: 32px;">
                            <asp:Button ID="btninoutletters" runat="server" CssClass="btn-lg" Font-Bold="True" Font-Size="Small" Height="38px"  Text="New Incoming/Outgoing Letters/Memo" Width="286px" OnClick="btninoutletters_Click"  />
                            </td>
                     ...
                     <tr>
                        <td style="width: 124px; text-align: right; height: 32px;">
                            &nbsp;</td>
                        <td style="width: 225px; height: 32px;">
                            <asp:Button ID="btndpt" runat="server" CssClass="btn-lg" Font-Bold="True" Font-Size="Small" Height="38px"  Text="Add/Create New Department" Width="286px" OnClick="btndpt_Click"  />
                            </td>
                        <td style="height: 32px"></td>
                        <td style="height: 32px"></td>
                        <td style="height: 32px"></td>
                     ...
                     <tr>
                        <td style="width: 124px; text-align: right; height: 32px;">
                            &nbsp;</td>
                        <td style="width: 225px; height: 32px;">
                            <asp:Button ID="btnDvs" runat="server" CssClass="btn-lg" Font-Bold="True" Font-Size="Small" Height="38px"  Text="Add/Create New Division" Width="286px" OnClick="btnDvs_Click"  />
                            </td>
                        <td style="height: 32px"></td>
                        <td style="height: 32px"></td>
                        <td style="height: 32px"></td>
                     ...
                     <tr>
                        <td style="width: 124px; text-align: right; height: 32px;">
                            &nbsp;</td>
                        <td style="width: 225px; height: 32px;">
                            <asp:Button ID="btnUnit" runat="server" CssClass="btn-lg" Font-Bold="True" Font-Size="Small" Height="38px"  Text="Add/Create New Unit" Width="286px" OnClick="btnUnit_Click"  />
                            </td>
                        <td style="height: 32px"></td>
                        <td style="height: 32px"></td>
                        <td style="height: 32px"></td>
