<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="division.aspx.cs" Inherits="division" %>
        ...
        <tr>
            ...
            <td style="vertical-align: top;">
                <table style="width: 937px; background-color: #009933; ">
                    <tr>
                        <td colspan="6" style="border: thin solid #FFFFFF; background-color: #FFFFFF; height: 26px;">NEW DIVISION ADDITION/CREATION PLATFORM</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="height: 46px">
                            <asp:DropDownList runat="server" CssClass="form-control" Width="237px" ID="dpldcode" AutoPostBack="True" DataSourceID="SqlDataSource2" DataTextField="DepartmentCode" DataValueField="DepartmentCode"></asp:DropDownList>
                            ...
                            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:FileArchiveDBConnectionString %>" SelectCommand="SELECT [DepartmentCode] FROM [DepartmentsInfo] WHERE ([DepartmentName] = @DepartmentName)">
                                <SelectParameters>
                                    <asp:ControlParameter ControlID="dpldname" Name="DepartmentName" PropertyName="SelectedValue" Type="String" />
                                </SelectParameters>
                            </asp:SqlDataSource>
                    ...
                    <tr>
                        ...
                        <td style="width: 181px; height: 47px; color: #FFFFFF;">
                            Department Name :</td>
                        <td style="height: 47px"><asp:DropDownList runat="server" CssClass="form-control" Width="237px" ID="dpldname" AutoPostBack="True" DataSourceID="SqlDataSource1" DataTextField="DepartmentName" DataValueField="DepartmentName"></asp:DropDownList>
                     ...
                     <tr>
                        ...
                        <td style="height: 43px">
                            <asp:TextBox ID="txtsname" runat="server" CssClass="form-control" Width="194px"></asp:TextBox>
                         </td>
