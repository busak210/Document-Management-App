<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="filemovt.aspx.cs" Inherits="filemovt" %>
        ...
        <tr>
            ...
            <td style="vertical-align: top;">
                <table style="width: 937px; background-color: #009933; ">
                    <tr>
                        <td colspan="6" style="border: thin solid #FFFFFF; background-color: #FFFFFF; height: 26px;">FILE MOVEMENT PLATFORM</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="color: #FFFFFF;" colspan="4" rowspan="5">
                            ...
                            <table border="1" BorderColor= "white" >
                                <tr>
                                    <td class="auto-style1" style="color: #FFFFFF; height: 28px; width: 119%;">
                                    ...
                                    <td width="600px" style="height: 28px">
                                ...
                                <tr>
                                    <td class="auto-style1" style="color: #FFFFFF; width: 119%;">
                                ...
                                <tr>
                                    ...
                                    <td colspan="2" width="600px">
                                        <asp:TextBox ID="txtpriority" runat="server" Font-Names="Times New Roman" Font-Size="Medium" ForeColor="#006600" style="font-weight: 700" Width="585px" Enabled="False"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="auto-style1" style="color: #FFFFFF; height: 28px; width: 119%;">
                                ...
                                <tr>
                                    <td class="auto-style1" valign="top" style="color: #FFFFFF; width: 119%;">
                                ...
                                <tr>
                                    <td class="auto-style1" valign="top" style="color: #FFFFFF;" colspan="3">
                                        <asp:Label ID="Label26" runat="server" Font-Bold="True" Font-Names="Times New Roman" Font-Size="Medium" ForeColor="#003300" Text="File Minuted From :"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="auto-style1" valign="top" style="color: #FFFFFF; width: 119%;">
                                        <asp:Label ID="Label28" runat="server" Font-Bold="False" Font-Names="Times New Roman" Font-Size="Medium" ForeColor="White" style="font-weight: 700" Text="Officer's Rank :"></asp:Label>
                                    </td>
                                    <td colspan="2" width="600px">
                                        <asp:TextBox ID="txtorank" runat="server" Font-Names="Times New Roman" Font-Size="Medium" ForeColor="#006600" style="font-weight: 700" Width="585px" Enabled="False"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="auto-style1" valign="top" style="color: #FFFFFF; width: 119%;">
                                        <asp:Label ID="Label27" runat="server" Font-Bold="False" Font-Names="Times New Roman" Font-Size="Medium" ForeColor="White" style="font-weight: 700" Text="Officer's Name :"></asp:Label>
                                    </td>
                                    <td colspan="2" width="600px">
                                        <asp:TextBox ID="txtoname" runat="server" Font-Names="Times New Roman" Font-Size="Medium" ForeColor="#006600" style="font-weight: 700" Width="585px" Enabled="False"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td class="auto-style1" style="color: #FFFFFF; height: 23px; width: 119%;"></td>
