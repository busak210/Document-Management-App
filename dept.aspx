                ...
                <table style="width: 937px; background-color: #009933; ">
                    ...
                    <tr>
                        ...
                        <td style="height: 46px">
                            <asp:TextBox ID="txtdname" runat="server" CssClass="form-control" Width="194px"></asp:TextBox>
                        </td>
                    ...
                    <tr>
                        ...
                        <td style="width: 181px; height: 47px; color: #FFFFFF;">
                            Department Type :</td>
                        <td style="height: 47px"><asp:DropDownList runat="server" CssClass="form-control" Width="237px" ID="dpldtype" AutoPostBack="True">
                    ...
                    <tr>
                        ...
                        <td style="width: 181px; height: 46px; color: #FFFFFF;">
                            Category :</td>
                        <td style="height: 46px"><asp:DropDownList runat="server" CssClass="form-control" Width="237px" ID="dpldcat" AutoPostBack="True" DataSourceID="SqlDataSource1" DataTextField="catName" DataValueField="catName"></asp:DropDownList>

                                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:FileArchiveDBConnectionString %>" SelectCommand="SELECT DISTINCT [catName] FROM [DeptCategory] ORDER BY [catName]"></asp:SqlDataSource>
                     ...
                     <tr>
                        ...
                        <td style="width: 181px; height: 43px; color: #FFFFFF;">
                            Department Head Title :</td>
                        <td style="height: 43px">
                            <asp:TextBox ID="txtdht" runat="server" CssClass="form-control" Width="194px"></asp:TextBox>
                         </td>
                     ...
                     <tr>
                        <td style="width: 124px; text-align: right; height: 45px;">
                            </td>
                        <td style="width: 181px; height: 45px; color: #FFFFFF;">
                            Department Head Name :</td>
                        <td style="height: 45px">
                            <asp:TextBox ID="txtdhn" runat="server" CssClass="form-control" Width="194px"></asp:TextBox>
                         </td>
